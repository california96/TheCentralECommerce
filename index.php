...
<?php
  ...
  FROM products INNER JOIN categories on products.categoryID = categories.categoryID WHERE products.status = 1";
        ...
        <div class="row no-gutters align-items-center pt-60px">
          ...
          <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div class="hero-banner__content">
              <h1>Hello, and welcome to The Central</h1>
              <h4>Browse products from Game Changers</h4>
        ...
        <div class="row">
          <div class="col-xl-5">
            <div class="offer__content text-center">
              <h3>Up To 50% Off</h3>
              <h4>Some event</h4>
              <p>Placeholder for event sales</p>
    ...
    <!--section class="subscribe-position">
      <div class="container">
        <div class="subscribe text-center">
          ...
          <p>You will receive email alerts for new items on sale.</p>
