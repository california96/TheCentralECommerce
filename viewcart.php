...
<body>
                              ...
                              <td>
                                  <div class="product_count">
                                      <input type="number" name="qty" id="sst" maxlength="12" value=<?php echo $item['qty'];?> title="Quantity:"
                                          class="input-text qty" onchange="updateCartItem(this, '<?php echo $item['productID']; ?>')" min="1" max="12">
  ...
  function updateCartItem(obj,id){
    $.get("cartAction.php", {action:"updateCartItem", id:id, qty:obj.value}, function(data){
        ...
        //Sswitched if and else conditions something wrong with ok having a breakline when begin echoed back from cartAction.php
    });
}
    </script>
</body>
